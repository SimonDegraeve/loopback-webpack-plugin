...
var mockEmpty = 'webpack/node_modules/node-libs-browser/mock/empty';
...
LoopbackBootPlugin.prototype.apply = function(compiler) {
  ...
  [
    ...
    {regExp: /^\.\/express-middleware$/, path: mockEmpty},
    {regExp: /^fs$/, path: mockEmpty},
  ...
  // Remove warnings that we are handling
  compiler.plugin('done', function(stats) {
    stats.compilation.warnings = stats.compilation.warnings.filter(function(warning) {
      var request = warning.module && warning.module.request;
